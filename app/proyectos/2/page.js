      ...
      <nav className="nav">
        <div className="container">
          <div className="flex">
            ...
            <div className="right">
              <div className="page-name">Río Escondido, CDMX</div>
              {menuActive ? (
        ...
        <div className="container">
          <div className="main-image">
            <Image
              ...
              className="mainImg"
            />
            <div className="main-name">Río Escondido, CDMX</div>
            <div className="main-text">Proyecto: Grupo Arquitectura </div>
            <div className="main-text">Ubicacion: CDMX</div>
            <div className="main-text">Año: 2022</div>
          </div>
          <div className="gallery">
            <div
              className="gallery-item"
              style={{ backgroundImage: "url(/img/rio1.png)" }}
